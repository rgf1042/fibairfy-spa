module.exports = {
    ...
    chainWebpack: config => {
        config.plugin('define').tap(definitions => {
            ...
            definitions[0]['fiberfy.constants']['BASE_URL'] = JSON.stringify(
                'http://localhost:1337'
            );
            definitions[0]['fiberfy.constants']['API_VERSION'] = JSON.stringify(
                '/api/v1'
            );
            definitions[0]['fiberfy.constants'][
            ...
            ] = JSON.stringify('41.66060124302088');
            definitions[0]['fiberfy.constants'][
                'PROJECT_DEFAULT_LONGITUDE'
            ] = JSON.stringify('1.571044921875');
            definitions[0]['fiberfy.constants'][
